...
#
# O gatilho canonico do macro e o cron do Worker (0 3 * * 1 UTC, segunda
...
if ($t) {
    ...
    Write-Host "Tarefa nao existe, nao recriar. Gatilho canonico: cron do Worker 0 3 * * 1 UTC." -ForegroundColor DarkGray
}
