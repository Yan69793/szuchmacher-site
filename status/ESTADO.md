...
- Itens restantes do §Q do PRE-DEPLOY-2026-08-15: CSP sem unsafe-inline,
  `hero-*` legado e F5 cache-busting, todos com escopo próprio.
...
- Itens de escopo próprio do §Q: CSP sem unsafe-inline, `hero-*` legado, F5 cache-busting.
